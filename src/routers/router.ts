...
import { invitationConfirmationControllerGet } from "./controllers/invitationConfirmationController";
...
router.get(constants.INVITATION_CONFIRMATION_URL, invitationConfirmationControllerGet);
