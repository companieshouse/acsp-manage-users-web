...
export const stopPageAddOwnerControllerGet = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        const viewData: StopPageAddOwnerGetViewData = {
            ...
            linkHref: `${constants.UPDATE_AUTHORISED_AGENTS_DETAILS_URL}?lang=${req.lang}`,
