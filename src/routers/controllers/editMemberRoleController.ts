...
const getViewData = async (req: Request): Promise<EditMemberRoleViewData> => {
    ...
    const viewData: EditMemberRoleViewData = {
        ...
        userDisplayName: userToChangeRole.userDisplayName === constants.LANG_KEY_FOR_NOT_PROVIDED || userToChangeRole.userDisplayName === constants.NOT_PROVIDED ? undefined : userToChangeRole.userDisplayName,
