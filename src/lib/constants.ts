...
export const CORRECT_SOMEONES_IDENTITY_VERIFICATION_DETAILS_ENGLISH_URL = "https://submit.forms.service.gov.uk/form/8629/correct-someone-s-identity-verification-details/GiD648pc";
export const CORRECT_SOMEONES_IDENTITY_VERIFICATION_DETAILS_WELSH_URL = "https://submit.forms.service.gov.uk/form/8629/correct-someone-s-identity-verification-details.cy/GiD648pc";
export const ADD_OR_REMOVE_ACSPS_DETAILS_ENGLISH_URL = "https://submit.forms.service.gov.uk/form/262336/confirm-if-you-want-to-be-shown-on-the-public-list-of-authorised-corporate-service-providers-acsps/1050813";
export const ADD_OR_REMOVE_ACSPS_DETAILS_WELSH_URL = "https://submit.forms.service.gov.uk/form/262336/confirm-if-you-want-to-be-shown-on-the-public-list-of-authorised-corporate-service-providers-acsps.cy/1050813";
export const BEING_AN_ACSP_GUIDANCE_ENGLISH_URL = "https://www.gov.uk/guidance/being-an-authorised-corporate-service-provider";
export const BEING_AN_ACSP_GUIDANCE_WELSH_URL = "https://www.gov.uk/guidance/being-an-authorised-corporate-service-provider.cy";
...
export const FEATURE_FLAG_PERMIT_CH_ADMIN_TO_UNLOCK_ACCOUNTS = "FEATURE_FLAG_PERMIT_CH_ADMIN_TO_UNLOCK_ACCOUNTS";
