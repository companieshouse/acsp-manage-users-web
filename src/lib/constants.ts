...
export const INVITATION_CONFIRMATION_PAGE = "invitation-confirmation";
...
export const INVITATION_CONFIRMATION_URL = `/${INVITATION_CONFIRMATION_PAGE}`;
...
export const INVITATION_CONFIRMATION_FULL_URL = getFullUrl(INVITATION_CONFIRMATION_URL);
