...
export const REMOVE_MEMBER_CHECK_DETAILS_FULL_URL = getFullUrl(REMOVE_MEMBER_CHECK_DETAILS_URL);
export const STOP_PAGE_ADD_ACCOUNT_OWNER_URL_FULL_URL = getFullUrl(STOP_PAGE_ADD_ACCOUNT_OWNER_URL);
